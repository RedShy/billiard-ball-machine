...
int main(int argc, char **argv)
{
    ...
    MPI_Send_init(sub_matrix, columns, MPI_INT, process_up, 10, linearTopology, &request_send_up);

    MPI_Request request_recv_down;
    MPI_Recv_init(ghost_cells_down, columns, MPI_INT, process_down, 10, linearTopology, &request_recv_down);

    MPI_Request request_send_down;
    MPI_Send_init(ghost_cells_down, columns, MPI_INT, process_down, 12, linearTopology, &request_send_down);

    MPI_Request request_recv_up;
    MPI_Recv_init(sub_matrix, columns, MPI_INT, process_up, 12, linearTopology, &request_recv_up);
